                    ...
                    <div className="flex rounded-lg bg-orange-100 dark:bg-orange-500 p-4 mx-2 flex-wrap justify-evenly w-full md:w-[30rem]">
                        <div className="flex my-2 w-full">
                            ...
                            <span className="text-lg dark:text-gray-300 text-gray-700">
                                Parul Cafeteria, Football Ground
                                <br />
                                Parul University, Vadodara Campus
                            </span>
                                <br />
                                PU Campus,Limbda Vadodara Gujrat.
                            </span>
                        </div>
                        ...
                        <div className="pt-9">
                            <div className="mb-9 flex w-full justify-center ">
                                <a href="https://www.instagram.com/vipulpatil.1/" className="text-blue-800">
                                    <svg
                                ...
                                <a href="https://www.linkedin.com/in/vipulpatil1786/" className="mr-9 text-blue-800">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-10 w-10"
                                        fill="currentColor"
                                ...
                                <a href="https://github.com/1VIP1786" className="text-blue-800">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-10 w-10"
                                        fill="currentColor"
